...
public class FilmController {
	...
	public List<Film> filmsByRentalRate(@PathVariable("cost1") Double rentalCost1,
			@PathVariable("cost2") Double rentalCost2, HttpServletResponse req) {
	...
	public List<Film> filmsByReplacementCost(@PathVariable("replaceCost1") Double replaceCost1,
			@PathVariable("replaceCost2") Double replaceCost2, HttpServletResponse req) {
	...
	@GetMapping(path = "films/rating/{rating}")
	public List<Film> findByRating(@PathVariable("rating") Rating rating, HttpServletResponse req) {
		List<Film> films = filmService.findFilmByRating(rating);
		try {
			if (films == null) {
				req.setStatus(404);
			}
	...
	@GetMapping(path = "films/language/{language}")
